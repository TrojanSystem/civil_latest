...
class FileModelForAttendance {
  ...
  FileModelForAttendance(
      {this.id, this.date, this.title, this.price, this.name, this.phone});
}

class FileHandlerForAttendance extends ChangeNotifier {
  //final helper = DatabaseHelper.instance;

  List<FileModelForAttendance> fileList = [];

  // void initializeOptions(List<dynamic> fileList) {
  //   this.fileList = fileList;
  //   notifyListeners();
  // }
  void addLabour(FileModelForAttendance model) {
