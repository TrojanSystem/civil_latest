...
class TakeFromStorage extends StatefulWidget {
  const TakeFromStorage({Key key}) : super(key: key);

  @override
  State<TakeFromStorage> createState() => _TakeFromStorageState();
}

class _TakeFromStorageState extends State<TakeFromStorage> {
  void datePicker() {
    showDatePicker(
      context: context,
