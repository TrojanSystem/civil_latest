import 'package:example/first_thing/store/add_to_store/shop_model_database.dart';
import 'package:example/first_thing/store/add_to_store/shop_model_for_store.dart';
import 'package:flutter/material.dart';

class ShopModelDataForStore extends ChangeNotifier {
  ...
  List<ShopModelForStore> _shopList = [];

  List<ShopModelForStore> get shopList => _shopList;
  ...
  Future addShopList(ShopModelForStore task) async {
    await db.insertTask(task);
    await loadShopList();
    notifyListeners();
  }

  Future updateShopList(ShopModelForStore task) async {
